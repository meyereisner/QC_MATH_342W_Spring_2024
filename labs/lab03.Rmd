...
TO-DO: It creates a wedge where the middle 1 circle is kind of chasing the middle 0 circle. It's not a perfect reflection.
...
#It doesn't cut the wedge down the middle
...
Yes it splits the wedge in the middle
...
#'
#' @param Xinput      Historical Measurments
#' @param y_binary    Historical responses
#' @param Xtest       A matrix of measurments where each row is a unit you wish to predict the response for
...
#' @param y_binary    Historical responses
#' @param Xtest       A matrix of measurments where each row is a unit you wish to predict the response for
#' @param d           Distance function that measures distances betweeen two observations, which defaults to Squares Euclidean Distances    
#' @return            A vector of predicted responses
...
Because extreme characteristics in parents, would lead to less extreme characteristics in their children, regressing those characteristics to the mean.

Why should this effect be real?

Because extreme values are less likely to be replicated exactly due to a number of factors, therefore these characteristics would fall closer to the mean.
