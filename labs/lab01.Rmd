...
```{r}
my_reverse = function(vect_v){
  reversed_v = c(1 : length(vect_v)) 
  reversed_v[1 : length(vect_v)] = vect_v[length(vect_v) : 1] 
...
#gpt helped me with a lot of this code, I added my special touches tho
```
...
apple = (strsplit(lorem, split = "[.]"))
apple
sample(apple, length(apple), replace = FALSE)
